		...
		Blocks: []smdx.BlockElement{
			{
				...
				Points: []smdx.PointElement{
					...
					{Id: Alg, Offset: 56, Type: typelabel.Enum16, Access: "r", Mandatory: true, Label: "Algorithm", Description: "Algorithm used to compute the digital signature"},
					{Id: N, Offset: 57, Type: typelabel.Uint16, Access: "r", Mandatory: true, Label: "N", Description: "Number of registers comprising the digital signature."},
				},
			},
			{
				Length: 1,
